import {
  require_dist,
  require_dist2
} from "./chunk-GPRWK5OC.js";
import {
  require_hash,
  require_minimalistic_assert
} from "./chunk-ZCCU6SW5.js";
...
var import_tx = __toESM(require_dist2());
...
var Ecdsa = class {
  ...
  async signTronTx(endpoint, authParams, txData) {
    ...
    return `0x${import_buffer2.Buffer.from(JSON.stringify(tx)).toString("hex")}`;
  }
  async rpcRequest(endpoint, authParams, chainId, method, ...params) {
    ...
    const response = await fetch(url, {
      ...
      headers: {
        ...
        Authorization: `Basic ${import_buffer2.Buffer.from(`${authParams.project_uuid}:${authParams.project_client_key}`, "utf8").toString("base64")}`
      },
      body: JSON.stringify({
        id: +new Date(),
        jsonrpc: "2.0",
...
//# sourceMappingURL=esm-VR5TLQMW.js.map
