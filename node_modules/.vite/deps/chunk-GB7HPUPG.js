...
// node_modules/@particle-network/auth-core-modal/esm/chunk-4E5MO4OP.js
...
`;
var D = ({ onChange: t, value: a, keyboardInvisible: w }) => {
  let { t: k } = useTranslation(), [g, V] = (0, import_react.useState)(["", "", "", "", "", ""]), [o, i] = (0, import_react.useState)(a != null ? a : ""), [b, _] = (0, import_react.useState)([1, 2, 3, 4, 5, 6, 7, 8, 9, "", 0]), u = (r) => {
    o.length < 6 && i(o + "" + r);
  }, x = () => {
    if (o.length > 0) {
  ...
  return (0, import_react.useEffect)(() => {
    ...
    i(a != null ? a : "");
  }, [a]), w ? import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement("style", null, d), import_react.default.createElement("div", { className: "particle-keywords-map loading" }, import_react.default.createElement("img", { src: (m2(), n(c)).default, alt: "" }), import_react.default.createElement("p", null, k("account.payment_checking")), import_react.default.createElement(LoadingOutlined_default, { className: "loading-icon" }))) : import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement("style", null, d), import_react.default.createElement("div", { className: "particle-keywords-box" }, g.map((r, s) => import_react.default.createElement("span", { key: r + s, className: `input-item ${!r || "active"}` }, o[s] ? "\u25CF" : ""))), import_react.default.createElement("div", { className: "particle-keywords-map" }, b.map((r) => import_react.default.createElement("span", { className: "span", key: r, "data-value": r, onClick: () => {
    r !== "" && u(r + "");
  } }, r)), import_react.default.createElement("span", { className: "span del", onClick: x }, import_react.default.createElement(i0, { className: "img", name: "backspace" })), import_react.default.createElement(N, null)));
};
var Q = D;
...
//# sourceMappingURL=chunk-GB7HPUPG.js.map
