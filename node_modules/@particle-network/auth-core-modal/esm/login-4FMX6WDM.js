...
`;function lo($){let{sendCaptcha:r,setShowInputCaptcha:w,account:m,loginWithAccount:n,chain:u}=$,[N,A]=V(!1),{themeType:k,language:y}=ae(),[h,g]=V(""),{loginHandler:P}=re(),[d,x]=V(!1),[s,a]=V(!1),[C,b]=V(!1),[L,U]=V(!1),[M,j]=V(!1),{authCoreModal:z}=pe(),{t:_}=ao(),G=se(),q=ro(null),F=/^\d{6}$/,[H,O]=V(1e3),[D,o]=V(60);eo(()=>{if(D>0){let e=D-1;o(e),e===0&&O(void 0)}},H);let p=()=>{o(60),O(1e3)},f=()=>{m.includes("@")?I({email:m}):Ze({theme:k,language:y,getContainer:()=>z.rootBody}).then(e=>{I({phone:m,cf_turnstile_response:e})}).catch(()=>{G.error(_("error.server_20112"))})},I=e=>{r(e).then(()=>{p(),j(!1),U(!1)}).catch(()=>{o(0),O(void 0)})},S=e=>{a(!1);let i=e,B=/^[0-9]+$/g;i.length===0?(a(!1),x(!0)):B.test(i)?(x(!1),a(!1)):(x(!1),a(!0))},Q=e=>{x(!1),a(!1),b(!1),e=e||h,!(d||s)&&(F.test(e)?Z(e):((e.length>0&&e.length<6||!F.test(e))&&(a(!0),x(!1)),e.length===0&&(a(!1),x(!0))))},ee=async e=>{if(L)return;A(!0);let i;m.includes("@")?i={code:e,email:m,chain:u}:i={code:e,phone:m,chain:u};try{await P(i,!1)}catch(B){oe(B)}},oe=e=>{if(A(!1),Re(e)){let i=e.error_code;i===Ue.InvalidCode?b(!0):i===Ue.ResendCode&&(U(!0),j(!0))}},te=e=>{S(e),g(e),x(!1),a(!1),b(!1),U(!1),F.test(e)&&Z(e)},Z=to(oo(e=>{ee(e)},1e3,{leading:!0,trailing:!1}),[]),ne=()=>{var i;(i=document.getElementsByClassName("input-code-item")[Math.min(h.length,5)])==null||i.focus()},t=io(()=>{let e=[d?_("login.enter_captcha"):"",s?_("login.captcha_input_error"):"",C?_("login.invalid_code"):"",L?_("login.please_send_again"):""].map(i=>i.trim()).filter(i=>!!i).join(",");return e.includes(",")?e+".":e},[d,s,C,L]);return no(()=>{var B;let e=document.getElementsByClassName("react-input-code"),i=K=>K.preventDefault();return(B=e[0])==null||B.addEventListener("contextmenu",i),()=>{var K;(K=e[0])==null||K.removeEventListener("contextmenu",i)}},[]),E.createElement("div",{className:"captcha-box"},E.createElement("style",null,He),E.createElement("div",{className:"captcha-form"},E.createElement("div",{className:"input-code-content"},E.createElement("div",{onClick:ne},E.createElement(Te,{containerClassName:"react-input-code",inputClassName:"input-code-item",allowedCharacters:"numeric",length:6,ref:q,placeholder:" ",onChange:te})))),E.createElement("div",{className:"error-tip"},t),E.createElement("div",{className:"btn-box"},E.createElement($e,{type:"primary",htmlType:"submit",className:"primary-antd-btn submit-btn",onClick:()=>Q(),disabled:M,loading:N},_("common.confirm")),E.createElement($e,{className:"get-btn",disabled:D>0,type:"link",onClick:f},_("login.send_again")," ",D>0?`(${D}s)`:""),!n&&E.createElement("div",{className:"back-box",onClick:()=>{w(!1)}},E.createElement(le,{className:"arrow1-icon",name:"arrow1_icon"}),E.createElement("span",null,_("login.back")))))}var Fe=lo;import{Button as co,Form as ue,Input as po}from"antd";import T,{useEffect as mo,useRef as Be,useState as xe}from"react";import{useTranslation as uo}from"react-i18next";var X=`.login-style .form-item {
  margin-bottom: 0;
}
.login-header0 {
  display: flex;
...
`;function Ho($){var ee,oe,te,Z,ne;let{email:r,phone:w,code:m,jwt:n,socialType:u,nonce:N,prompt:A,authorization:k,chain:y}=$||{},{modalOptions:h,setLoginAuthorization:g}=pe(),{loginHandler:P,socialAuthLogin:d}=re(),x=()=>{var i,B,K,ye,ve;let t=(B=(i=h.authTypes)==null?void 0:i.indexOf(c.phone))!=null?B:-1,e=(ye=(K=h.authTypes)==null?void 0:K.indexOf(c.email))!=null?ye:-1;return u||(!_o(w)&&(t>=0||!((ve=h.authTypes)!=null&&ve.length))||!r&&(t>=0&&e<0||t>=0&&e>=0&&t<e)?c.phone:c.email)},[s,a]=R(x()),{t:C}=jo(),[b,L]=R(""),[U,M]=R(!1),[j,z]=R(!1),[_,G]=R(h.authTypes||[]),q=t=>{M(t)};be(()=>{document.documentElement.setAttribute("data-login-type",s||"")},[s]),be(()=>{if(j)G([]);else{let t=Object.values(c).filter(e=>e!==c.jwt);if(!h.authTypes)G(t);else{let e=h.authTypes.filter(i=>i!==c.jwt&&t.includes(i));u&&!e.includes(u)&&e.push(u),!e.includes(c.email)&&!e.includes(c.phone)&&e.length>0&&e.unshift(c.email),e.length===1&&(e[0]===c.email||e[0]===c.phone)&&(e.length=0),G(e)}}},[j,h.authTypes]),be(()=>{g(k?{authorization:k,chain:Eo(y)}:void 0),O()},[]);let F=async t=>(L("email"in t&&t.email?t.email:t.phone),await Lo(t).then(i=>i)),H=()=>m&&m.match(/^\d{6}$/),O=()=>{if(r&&s===c.email)ie.test(r)&&(H()?D({email:r,code:m,chain:y}):(z(!0),L(r)));else if(w&&s===c.phone){let t=we(w);t&&(H()?D({phone:t,code:m,chain:y}):(z(!0),L(t)))}else n?(a(c.jwt),z(!0),D({jwt:n,chain:y})):u&&(m&&N?D({socialType:u,code:m,nonce:N,chain:y}):o(u))},D=So(t=>{P(t)},[P]),o=t=>{a(t),d({socialType:t,prompt:A,authorization:k,chain:y})},p=()=>{if(U)return v.createElement(Fe,{sendCaptcha:F,setShowInputCaptcha:q,account:b,loginWithAccount:j,chain:y});if(s===c.email&&!H())return v.createElement(Ve,{sendCaptcha:F,setShowInputCaptcha:q,setLoginType:f,account:r||b,supportAuthTypes:_,loginWithAccount:!!r||j});if(s===c.phone&&!H())return v.createElement(Qe,{sendCaptcha:F,setShowInputCaptcha:q,setLoginType:f,account:w||b,supportAuthTypes:_,loginWithAccount:!!w||j})},f=t=>{a(t)},I=t=>t===c.jwt?"JWT":t.titleCase(),S=t=>t===c.jwt?C("login.create_wallet"):C("login.social_login").format(I(t)),Q=Po(()=>{var e;let t=(e=h.customStyle)==null?void 0:e.logo;return t||(t=me),t||""},[(ee=h.customStyle)==null?void 0:ee.logo]);return v.createElement("div",{className:"login-container-box"},v.createElement("style",null,X),v.createElement("style",null,Je),v.createElement("div",{className:"wrap"},v.createElement("div",{className:"login-logo"},v.createElement(Do,{className:"product-logo",preview:!1,height:64,src:Q,key:Q,placeholder:v.createElement("div",{className:"placeholder-wrap"},v.createElement(Ao,{style:{fontSize:24},spin:!0})),fallback:me,onError:t=>{t.currentTarget.src=me}})),v.createElement("div",{className:"login-header0"},(te=(oe=h.customStyle)==null?void 0:oe.projectName)!=null?te:C("common.particle_auth")),U?v.createElement("div",{className:"login-des"},b):v.createElement("div",{className:"login-des"},(s===c.email||s===c.phone)&&!H()?(ne=(Z=h.customStyle)==null?void 0:Z.subtitle)!=null?ne:C("login.to_continue").format("App"):v.createElement("div",{className:"third-party-des"},S(s))),p(),!U&&!j&&(s===c.email||s===c.phone)&&!H()&&v.createElement(Ye,{supportAuthTypes:_,preferredAuthType:s,onPreferredAuthTypeChange:a,thirdpartyAuthLogin:o})),v.createElement(Ce,{className:"footer-box-v2"}))}var en=Ho;export{en as default};
