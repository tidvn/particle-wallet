...
export declare type SendTransactionParams = UserOpBundle | UserOpParams;
export declare type ResolveTransactionParams = UserOpBundle | Omit<UserOpParams, 'tx'>;
export declare enum SmartAccountType {
    SIMPLE = "SIMPLE",
